...
def training_loop(
    ...
    resume_run_id           = '/content/drive/MyDrive/tmp/',     # Run ID or network pkl to resume training from, None = start from scratch.
    resume_snapshot         = None,     # Snapshot index to resume training from, None = autodetect.
    resume_kimg             = 15000.0,      # Assumed training progress at the beginning. Affects reporting and training schedule.
    ...
    while cur_nimg < total_kimg * 1000:
        ...
        if cur_nimg >= tick_start_nimg + sched.tick_kimg * 1000 or done:
            ...
            if cur_tick % network_snapshot_ticks == 0 or done or cur_tick == 1:
                ...
                misc.save_pkl((G, D, Gs), os.path.join('/content/drive/MyDrive/tmp/pkls/bedroom', 'network-snapshot-%06d.pkl' % (cur_nimg // 1000)))
